...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, SupplierSelectorModalComponent, VehicleSelectorModalComponent, DriverSelectorModalComponent, WarehouseSelectorModalComponent],
